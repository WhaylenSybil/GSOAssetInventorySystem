  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Property Return Slip (PRS) Master List</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-minus-circle"> PRS</i></a></li>
        </ol>
      </section>
      
      <section class="content container-fluid">
        <!-- Button for adding ARE in the table -->
        <a href="add_PRS.php" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i>&nbsp Add PRS</a><br>
        <!-- End of Button for adding ARE in the table -->
        <!-- Import file from your computer device and save it to the database -->
       <BR> <section class="">
            <form enctype="multipart/form-data" method="POST" action="importPRS.php">
              <input type="file" name="file" id="file" accept=".xlsx, .xls"><br>
              <button type="submit" name="importPRS" class="btn btn-primary">IMPORT</button>
            </form>
        </section>
        ...
        <div class="box">
          <div class="box-header bg-blue" align="center">
            <h4 class="box-title">Property Return Slip Master List (PRS)</h4>
          </div><br>
              ...
              <table id="PRStable" class="table table-hover responsive" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2">SCANNED PRS DOCUMENTS</th>
                ...
                <tbody>
                  <?php include_once("../admin_page/manage_PRS_table.php") ?>
                </tbody>
              </table>
           </div>
        </div><br>
...
<!-- Required Scripts -->
  ...
  <!-- Function to show a success modal with an OK button -->
  <script>
      function showSuccessModal(message, redirectPage) {
      ...
      // Function to show an error modal with an OK button
