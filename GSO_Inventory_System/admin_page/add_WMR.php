...
include ('../admin_page/includes/save_add_WMR.php');
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>Waste Material Report (WMR)</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.html"><i class="fa fa-dashboard"></i>Waste Material Report (WMR)</a></li>
          <li class="active">Add Waste Material Slip</li>
        </ol>
      </section>     
    ...
    <section class="content container-fluid">
      <div class="box">
        <div class="box-header bg-blue" align="center">
          <h4 class="box-title">Waste Material Report Master List</h4>
        </div><br>
        <div class="row">
          <div class="col-md-12">
            <form method="POST" action="" enctype="multipart/form-data">
              <div class="col-md-3" style="display: none;"><!-- Type, Either PRS or WMR -->
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="type" placeholder="WMR" name="type" autocomplete="off" value="WMR">
                </div>
              ...
              <div class="col-md-3" style="display: none;"><!-- On hand per count qty -->
                <div class="form-group">
              ...
              <div class="col-md-3"><!-- IIRUP Date -->
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="iirupDate" id="iirupDate" placeholder="Date of IIRUP" autocomplete="off">
                </div>
              ...
              <div class="col-md-3"><!-- With Attachment -->
                <div class="form-group">
                  <input type="checkbox" class="form-check-input" name="withAttachment" id="withAttachment">
                  <label for="withAttachment">With Attachment</label>
                </div>
              </div><!-- end of with attachment -->
              <div class="col-md-3"><!-- with Cover Page -->
                <div class="form-group">
                  <input type="checkbox" class="form-check-input" name="withCoverPage" id="withCoverPage">
                  <label for="withCoverPage">With Cover Page</label>
                </div>
              </div><!-- end of with cover page -->
              <br><br>
...
<!-- =================================Current Updates======================================================== -->
              ...
              <div class="col-md-12"><!-- Save Button PRS -->
                <div class="form-group">
                  <button type="submit" class="btn btn-success" name="btn_WMR_save" onClick="">Add WMR</button>
                </div>
