	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				REGISTRY</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"> Registy</i></a></li>
				</ol>
			</section>
			<section class="content container-fluid">
				...
				<div class="box box-primary">
					<div class="box-header with-border bg-blue text-center">
						<h3 class="box-title">Registy of Different Properties</h3>
					</div>
					<div class="box-body">
					<div class="row">
			<!-- Start of Registry of ARE properties -->
						...
						<div class="col-lg-12">
							<!-- for small screen -->
							<a href="registry_of_ARE_properties.php" class="box-link">
								<div class="small-box bg-red">
									<div class="inner">
										<h3 align="center">Registry of ARE-Issued Property</h3>
									</div>
								</div>
							</a>
			...
			<!-- Start of Registry of ICS Properties -->
						<!-- for full screen -->
						<div class="col-lg-12">
							<a href="registry_of_ICS_properties.php" class="box-link">
								<div class="small-box bg-green">
									<div class="inner">
										<h3 align="center">Registry of ICS-Issued Property</h3>
									</div>
								</div>
							</a>
