...
include ('../admin_page/includes/manage_edit_inactivePPE.php');
?>
    ...
    <div class="wrapper">
    	...
    	<div class="content-wrapper">
    		<section class="content-header">
    			<h1>Edit Inactive PPE</h1>
    			<ol class="breadcrumb">
    				<li><a href="dashboard.php"><i class="fa fa-dashboard"></i>Edit Inactive PPE</a></li>
    				<li class="active">Edit Inactive PPE</li>
    			</ol>
    		</section>
    		<section class="content container-fluid">
    			<div class="box">
    				<div class="box-header bg-blue" align="center">
    					<h4 class="box-title">Edit Inactive PPE</h4>
    				</div><br>
    				<div class="row">
    					<div class="col-md-12">
	    					<form action="" method="post" enctype="multipart/form-data">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    ...
		    						    <input type="text" class="form-control" id="brand" placeholder="Brand/Model" name="brand" style="text-transform: uppercase;" value="<?php echo $row['brand']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <label for="serialno"> Serial Number</label>
		    						    <input type="text" class="form-control" id="serial_no" placeholder="Serial Number" name="serial_no" value="<?php echo $row['serialno']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <label for="particulars"> Particulars</label>
		    						    <input type="text" class="form-control" id="particulars" placeholder="Particulars" name="particulars" value="<?php echo $row['particulars']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
	    						...
	    						<div class="col-md-3"><!-- Current Condition -->
	    							<div class="form-group">
	    						        ...
	    						        <input list="current_condition_options" class="form-control" id="current_condition_input" placeholder="Enter or select Current Condition" name="current_condition_input" value="<?php echo $row['currentconditionid']; ?>">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    ...
		    						    <input type="text" class="form-control" id="remarks" placeholder="Remarks"name="remarks" value="<?php echo $row['remarks']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
	    						...
	    						<div class="col-md-2"><!-- Save Button Registry -->
	    							<div class="form-group">
	    								<button type="submit" class="btn btn-success" name="btn_inactivePPE_update" onClick="">UPDATE</button>
	    							</div>
	    						</div><!-- End of Save Button Registry -->
	    						<div class="col-md-2"><!-- Cancel Button Registry -->
	    							<div class="form-group">
	    								<a href="inactivePPE.php" class="btn btn-danger">Cancel</a>
	    							</div>
