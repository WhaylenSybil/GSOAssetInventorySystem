...
include ('../admin_page/includes/manage_edit_activePPE.php');
?>
    ...
    <div class="wrapper">
    	...
    	<div class="content-wrapper">
    		<section class="content-header">
    			<h1>Edit ARE REGISTRY</h1>
    			<ol class="breadcrumb">
    				<li><a href="dashboard.php"><i class="fa fa-dashboard"></i>Edit ARE REGISTRY</a></li>
    				<li class="active">Edit ARE REGISTRY</li>
    			</ol>
    		</section>
    		<section class="content container-fluid">
    			<div class="box">
    				<div class="box-header bg-blue" align="center">
    					<h4 class="box-title">Edit Registry of ARE-Issued</h4>
    				</div><br>
    				<div class="row">
    					<div class="col-md-12">
	    					<form action="" method="post" enctype="multipart/form-data">
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    ...
		    						    <input type="date" class="form-control" id="date_recorded" name="date_recorded" value="<?php echo $row['date_recorded']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <label for="ARE_no"> ARE/MR Number</label>
		    						    <input type="text" class="form-control" id="ARE_no" placeholder="ARE/MR Number" name="ARE_no" value="<?php echo $row['AREno']; ?>" autocomplete="off">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="unit_value"> Unit Value</label>
		    						    <input type="text" class="form-control" id="unit_value" placeholder="Unit Value" name="unit_value" onblur="validateUnitValue(this)" value="<?php echo $row['unitvalue']; ?>" autocomplete="off">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="balance_per_card"> Balance per Card Qty</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="acquisition_cost"> Acquisition Cost</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="article"> Article</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-4">
		    						    <br><label for="brand"> Brand/Model</label>
		    						    <textarea type="text" class="form-control" id="brand" placeholder="Brand/Model" name="brand" style="text-transform: uppercase;"><?php echo $row['brand']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-4">
		    						    <br><label for="serialno"> Serial Number</label>
		    						    <textarea type="text" class="form-control" id="serial_no" placeholder="Serial Number" name="serial_no"><?php echo $row['serialno']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-4">
		    						    <br><label for="particulars"> Particulars</label>
		    						    <textarea type="text" class="form-control" id="particulars" placeholder="Particulars" name="particulars"><?php echo $row['particulars']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="engas"> eNGAS Property Number</label>
		    						    <input type="text" class="form-control" id="engas" placeholder="enGAS Property Number" name="engas" value="<?php echo $row['eNGAS']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="property_no"> Property Number</label>
		    						    <input type="text" class="form-control" id="property_no" placeholder="Property Number" name="property_no" value="<?php echo $row['propertyno']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="accountnumber"> Classification</label>
    						            <input list="classification_options" class="form-control" id="accountnumber" placeholder="Classification" name="accountnumber" value="<?php echo $row['classification_id']; ?>">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="est_life"> Estimated Useful Life</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="unit_measure"> Unit of Measure</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="onhand_per_count"> On-hand per Count Qty</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="shortage_overage_qty"> Shortage/Overage Qty</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="shortage_overage_value"> Shortage/Overage Value</label>
	    						...
	    						<div class="form-group"><!-- Accountable Person  -->
	    						    <div class="col-md-3">
	    						        <br><label for="accountable_person"> Accountable Employee</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="previous_condition"> Previous Condition</label>
		    						    <input type="text" class="form-control" id="previous_condition" placeholder="Previous Condition" name="previous_condition" value="<?php echo $row['previouscondition']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
	    						...
	    						<div class="col-md-3"><!-- Current Condition -->
	    							<div class="form-group">
	    								<br><label for="current_condition"> Current Condition</label>
	    						        <input list="current_condition_options" class="form-control" id="current_condition_input" placeholder="Enter or select Current Condition" name="current_condition_input" value="<?php echo $row['currentconditionid']; ?>" autocomplete="off">
	    						...
	    						<div class="col-md-3"><!-- Current Condition Input -->
	    						    <div class="form-group">
	    						    	<br><label for="other_condition"> Other Condition</label>
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="date_of_physical_inventory">Date of Physical Inventory</label>
		    						    <input type="text" name="date_of_physical_inventory" id="date_of_physical_inventory" class="form-control" placeholder="Date of Physical Inventory" value="<?php echo $row['date_of_physical_inventory']; ?>">
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-6">
		    						    <br><label for="remarks"> Remarks</label>
		    						    <textarea type="text" class="form-control" id="remarks" placeholder="Remarks"name="remarks"><?php echo $row['remarks']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
		    						    <br><label for="scanned_docs">Scanned Supporting Documents</label>
		    						    <input type="file" class="form-control" id="scanned_docs" name="scanned_docs" accept=".pdf">
	    						    </div>
								</div>
								<div class="form-group">
								    <div class="col-md-3">
								        <br><label for="saved_scanned_file">Saved Scanned Document</label>
								        <input type="text" class="form-control" id="saved_scanned_file" name="saved_scanned_file" value="<?php echo $row['scannedARE']; ?>" readonly>
								    </div>
								</div>
	    						<br><br>
	    						<div class="row">
	    							<div class="col-md-12">
			    						...
			    						<div class="form-group">
			    							<div class="col-md-3">
				    						    ...
				    						    <input type="text" name="supplier" class="form-control" placeholder="Supplier" id="supplier" value="<?php echo $row['supplier']; ?>">
			    						    </div>
			    						</div>
			    						<div class="form-group">
			    							<div class="col-md-2">
				    						    <label for="PO_no">PO No.</label>
				    						    <input type="text" name="PO_no" class="form-control" placeholder="PO No." id="PO_no" value="<?php echo $row['PO_no']; ?>">
			    						    </div>
			    						</div>
			    						<div class="form-group">
			    							<div class="col-md-2">
				    						    <label for="AIR_RIS_no">AIR/RIS No.</label>
				    						    <input type="text" name="AIR_RIS_no" class="form-control" placeholder="AIR/RIS No"id="AIR_RIS_no" value="<?php echo $row['AIR_RIS_no']; ?>">
			    						    </div>
			    						</div>
			    						<div class="form-group">
			    							<div class="col-md-3">
				    						    <label for="notes">Notes</label>
				    						    <input type="text" name="notes" class="form-control" placeholder="Notes" id="notes" value="<?php echo $row['notes']; ?>">
			    						    </div>
			    						</div>
			    						<div class="form-group">
			    							<div class="col-md-2">
				    						    <label for="jev">JEV Number</label>
				    						    <input type="text" name="jev" id="jev" class="form-control" placeholder="JEV Number" value="<?php echo $row['jevno']; ?>">
			    						    </div>
			    						</div>
	    						...
	    						<div class="col-md-2"><!-- Save Button Registry -->
	    							<div class="form-group">
	    								<button type="submit" class="btn btn-success" name="btn_ARE_update" onClick="">UPDATE</button>
	    							</div>
	    						</div><!-- End of Save Button Registry -->
	    						<div class="col-md-2"><!-- Cancel Button Registry -->
	    							<div class="form-group">
	    								<a href="active_PPE.php" class="btn btn-danger">Cancel</a>
	    							</div>
...
<script>
  function validateUnitValue(input) {
    ...
    if (unitValue < 50000) {
      ...
      message.innerHTML = "Unit Value must be 50,000 or higher.";
