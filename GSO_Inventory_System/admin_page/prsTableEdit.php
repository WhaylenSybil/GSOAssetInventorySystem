          ...
          <div class="col-md-12">
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="col-md-3"><!-- With Attachment -->
                <div class="form-group">
                  <input type="checkbox" class="form-check-input" name="withAttachment" id="withAttachment" <?php echo ($row['withAttachment'] === "YES") ? 'checked' : ''; ?>>
                  <label for="withAttachment">With Attachment</label>
                </div>
              </div><!-- end of with attachment -->
              <div class="col-md-3"><!-- with Cover Page -->
                  <div class="form-group">
                      <input type="checkbox" class="form-check-input" name="withCoverPage" id="withCoverPage" <?php echo ($row['withCoverPage'] === "YES") ? 'checked' : ''; ?>>
                      <label for="withCoverPage">With Cover Page</label>
                  </div>
              </div><!-- end of with cover page -->
              <div class="form-group">
                    <div class="col-md-3">
                        <br><label for="scannedPRS">Scanned Supporting Documents</label>
