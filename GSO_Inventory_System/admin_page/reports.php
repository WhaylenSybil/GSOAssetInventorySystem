								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6 col-sx-12">
										<div class="info-box">
											<span class="info-box-icon bg-orange"><i class="fa fa-files-o"></i></span>
											<div class="info-box-content">
												<span class="info-box-number">PER ACCOUNT</span>
									...
									<div class="col-md-4 col-sm-6 col-sx-12">
										<div class="info-box">
											...
											<div class="info-box-content">
												...
												<i class="fa fa-print"></i><a href="clearancePrint.php" class="small-box-footer" target="_blank">Print Clearance Master List</a>
											</div><!-- info box content -->
										</div><!-- info box -->
									</div>
								</div>
