<?php
  ...
  $sql = "SELECT
    ...
    WHERE a.currentconditionid = 'Returned'
    ORDER BY
  ...
  while ($rows = mysqli_fetch_array($result)) {
    $formattedDate = !empty($rows["date_recorded"]) ? date("m-d-Y", strtotime($rows["date_recorded"])) : "00-00-0000";
    $formattedAcDate = ($rows["acquisitiondate"] != "0000-00-00") ? date("m-d-Y", strtotime($rows["acquisitiondate"])) : "00-00-0000";
    ...
    <tr>
      ...
      <!-- <td>
        <a href="manage_inactivePPE_edit.php?equipmentid=<?php echo $rows['equipmentid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
      </td> -->
    </tr>
    <?php
  }
