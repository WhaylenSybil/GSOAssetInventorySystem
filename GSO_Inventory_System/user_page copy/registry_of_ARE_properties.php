...
include ('../admin_page/includes/save_add_ARE_registry.php');
?>
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Add ARE Registry</li>
				</ol>
			</section>
		...
		<section class="content container-fluid">
			<div class="box">
				<div class="box-header bg-blue" align="center">
					<h4 class="box-title">Registry of ARE-Issued</h4>
				</div><br>
				<div class="row">
					<form action="save_add_ARE_registry.php" id="ARE_issued_form"></form>
					...
					<div class="col-md-12">
						<form method="post" action="" enctype="multipart/form-data">
							<div class="col-md-3"><!-- Date Recorded -->
								<div class="form-group">
									<label for="date_recorded"> Date Recorded</label>
									<!-- <input type="date" class="form-control" id="date_recorded" placeholder="Date Recorded" name="date_recorded" autocomplete="off" required> -->
									<input type="date" class="form-control" id="date_recorded" placeholder="Date Recorded" name="date_recorded" autocomplete="off" required max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>">
								</div>
							...
							<div class="col-md-3"><!--ARE/MR Number -->
								<div class="form-group">
									...
									<input type="text" class="form-control" id="ARE_no" placeholder="ARE/MR Number" name="ARE_no" autocomplete="off">
								</div>
							...
							<div class="col-md-3"><!-- Acquisition Cost -->
								<div class="form-group">
									...
									<input type="text" class="form-control" id="acquisition_cost" placeholder="Acquisition Cost" name="acquisition_cost" readonly>
								</div>
							...
							<div class="col-md-3"><!-- Shortage/Overage qty -->
								<div class="form-group">
									...
									<input type="text" class="form-control" id="shortage_overage_qty" placeholder="Shortage/Overage Qty" name="shortage_overage_qty" readonly>
								</div>
							...
							<div class="col-md-3"><!-- Shortage/Overage value -->
								<div class="form-group">
									...
									<input type="text" class="form-control" id="shortage_overage_value" placeholder="Shortage/Overage Value" name="shortage_overage_value" readonly>
								</div>
							...
							<div class="col-md-2"><!-- Save Button Registry -->
								<div class="form-group">
									<button type="submit" class="btn btn-success" name="btn_ARE_save" onClick="">Add ARE Registry</button>
								</div>
