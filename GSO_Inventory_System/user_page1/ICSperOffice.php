...
$sql = "SELECT DISTINCT responsibilitycenter_id FROM ics_properties WHERE responsibilitycenter_id IS NOT NULL AND responsibilitycenter_id <> ''
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                Per Office/Department(Responsibility Center) ICS</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-cube"> Per Office/Department(Responsibility Center) ICS</i></a></li>
                </ol>
            </section>
            <section class="content container-fluid">
                <div class="box box-primary">
                    <div class="box-header with-border bg-blue text-center">
                        <h2 class="box-title">Per Office/Department(Responsibility Center) ICS</h2>
                    </div>
                    <div box-body>
                        <div class="row"><br>
                         <!-- Display Responsibility Centers based on the data from are_properties -->
                          <?php foreach ($responsibilityCenters as $center) : ?>
                            <div class="col-md-4">
                              <a href="ics_properties_by_responsibility_center.php?center=<?php echo urlencode($center['center']); ?>" class="box-link" target="_blank">
