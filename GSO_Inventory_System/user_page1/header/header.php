                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="ICSperAccountableEmployee.php">ICS by Accountable Employee</a></li>
                            <li><a href="ICSperYear.php">ICS by Year</a></li>
                            <li><a href="ICSperOffice.php">ICS by Office/Department</a></li>
                            <li><a href="ICSperAccountCode.php">ICS by Account Code</a></li>
