...
$YearArray = [];
$sql = "SELECT DISTINCT YEAR(date_recorded) AS year FROM are_properties";
$result = $connect->query($sql);

if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $year = $row['year']; // Use 'year' alias instead of 'date_recorded'
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                Per Year ARE Report</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-crosshairs"> Per Year ARE</i></a></li>
                </ol>
            </section>
            <section class="content container-fluid">
                <div class="box box-primary">
                    <div class="box-header with-border bg-blue text-center">
                        <h2 class="box-title">Per Year ARE</h2>
                    </div>
                    <div box-body>
                        <div class="row"><br>
                         <?php foreach ($YearArray as $dateYear) : ?>
                            <div class="col-md-4">
                              <a href="are_properties_by_year.php?dateYear=<?php echo urlencode($dateYear['dateYear']); ?>" class="box-link" target="_blank">
