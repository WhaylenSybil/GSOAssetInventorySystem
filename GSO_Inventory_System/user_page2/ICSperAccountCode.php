...
$accountCodes = [];
$sql = "SELECT DISTINCT i.classification_id, ac.account_title 
        FROM ics_properties i
        INNER JOIN account_codes ac ON i.classification_id = ac.account_number
        WHERE i.classification_id IS NOT NULL AND i.classification_id <> ''
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                Per Account(Classification) ICS</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-cube"> Per Account(Classification) ICS</i></a></li>
                </ol>
            </section>
            <section class="content container-fluid">
                <div class="box box-primary">
                    <div class="box-header with-border bg-blue text-center">
                        <h2 class="box-title">Per Account(Classification) ICS</h2>
                    </div>
                    <div box-body>
                        <div class="row"><br>
                         <!-- Display Accounts for Equipments based on the data from are_properties -->
                          <?php foreach ($accountCodes as $account) : ?>
                            <div class="col-md-6">
                              <a href="ics_properties_by_classification.php?classification=<?php echo urlencode($account['classificationId']); ?>" class="box-link" target="_blank">
