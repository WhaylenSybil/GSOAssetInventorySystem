...
$sql = "SELECT DISTINCT accountable_person FROM ics_properties";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                ICS Accountable Employees Report</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-crosshairs">ICS Accountable Employees</i></a></li>
                </ol>
            </section>
            <section class="content container-fluid">
                <div class="box box-primary">
                    <div class="box-header with-border bg-blue text-center">
                        <h2 class="box-title">ICS Accountable Employees</h2>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="row"><br>
                            <?php foreach ($AccountablePersonArray as $accountablePerson) : ?>
                                <div class="col-md-3 employee-box"> <!-- Add a class for employee boxes -->
                                    <a href="ics_properties_by_accountable_person.php?accountablePerson=<?php echo urlencode($accountablePerson['accountablePerson']); ?>" class="box-link" target="_blank">
                                        <div class="small-box <?php echo $accountablePerson['colorClass']; ?>">
                                            <div class="inner">
                                                <h4 class="employee-name" align="center"><?php echo $accountablePerson['accountablePerson']; ?></h4> <!-- Add a class for employee name -->
                                            </div>
                                        </div>
                                    </a>
                                </div>
                            <?php endforeach; ?>
                            <!-- End of Accountable Persons --> 
                        </div>
                    </div>
                </div>
