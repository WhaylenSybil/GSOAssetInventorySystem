...
<body>
    ...
    if (isset($_GET['accountablePerson'])) {
        ...
        // Retrieve ARE properties based on the provided accountable person
        $sql = "SELECT
                a.*,
        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                echo "<h3 style='text-align: center; line-height: 2em;'>Report on Physical Count of Property, Plant, and Equipment<br>Accountable Employee: <span style='text-decoration: underline;'>$accountablePerson</span></h3>";
