...
while ($rows = mysqli_fetch_array($result)) {
    $formattedDate = ($rows["dateReturnedRecorded"] != "0000-00-00") ? date("m-d-Y", strtotime($rows["dateReturnedRecorded"])) : " ";
    $formattedAcDate = ($rows["acquisitionDate"] != "0000-00-00") ? date("m-d-Y", strtotime($rows["acquisitionDate"])) : " ";
