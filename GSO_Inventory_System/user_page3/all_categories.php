  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa-window-maximize"></i> ALL CATEGORIES</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-window-maximize"> All Categories </i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
       ...
       <!-- <BR> <section class="">
            <form enctype="multipart/form-data" method="POST" action="import2.php">
              <input type="file" name="file" id="file" accept=".xlsx, .xls"><br>
              <button type="submit" name="import_btn" class="btn btn-primary">IMPORT</button>
            </form>
        </section> -->
        ...
        <div class="box">
          <div class="box-header bg-blue" align="center">
            <h4 class="box-title">ALL CATEGORIES (PPE and Semi-Expendable)</h4>
          </div><br>
            <div class="table-responsive">
              <table id="active_PPE" class="table table-hover responsive" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th rowspan="2">SCANNED SUPPORTING DOCUMENTS</th>
                    ...
                    <tr>
                        ...
                        <th class="subcolumn">ARE/PRS NUMBER</th>
                ...
                <tbody>
                  <?php include_once("../admin_page/manage_all_table.php") ?>
                </tbody>
              </table>
           </div>
        </div><br>
