  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa fa-minus-circle"></i> Inactive Property, Plant, and Equipments(PPE)</h1>
        <ol class="breadcrumb">
          <li><a href="inactive.php"><i class="fa fa-minus-circle"> Inactive PPE</i></a></li>
        </ol>
      </section>
       ...
       <!-- <BR> <section class="">
        ...
        <div class="box">
          <div class="box-header bg-blue" align="center">
            <h4 class="box-title">List of Inactive Property, Plant, and Equipment(PPE)</h4>
          </div><br>
            <div class="table-responsive">
              <table id="active_PPE" class="table table-hover responsive" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php include_once("../user_page3/manage_inactive_PPE_table.php") ?>
                </tbody>
              </table>
           </div>
        </div><br>
