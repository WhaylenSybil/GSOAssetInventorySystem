<?php
  ...
  while ($rows = mysqli_fetch_array($result)) {
    ...
    <tr>
      ...
      <td><?php echo $rows["currentcondition"]; ?></td>
      ...
      <td>
        <a href="manage_inactiveSemi_edit.php?ICSequipmentid=<?php echo $rows['ICSequipmentid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
      </td>
    </tr>
    <?php
  }
