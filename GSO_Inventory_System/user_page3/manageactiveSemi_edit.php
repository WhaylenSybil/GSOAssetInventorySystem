...
include ('../admin_page/includes/manage_edit_activeSemi.php');
...
if (isset($_GET['ICSequipmentid'])) {
	...
	if ($result->num_rows >0) {
		...
		header("Location: active_semi_expendable.php");
		exit();
	}
}
?>
    ...
    <div class="wrapper">
    	...
    	<div class="content-wrapper">
    		<section class="content-header">
    			<h1>Edit ICS REGISTRY</h1>
    			<ol class="breadcrumb">
    				<li><a href="dashboard.php"><i class="fa fa-dashboard"></i>Edit ICS REGISTRY</a></li>
    				<li class="active">Edit ICS REGISTRY</li>
    			</ol>
    		</section>
    		<section class="content container-fluid">
    			<div class="box">
    				<div class="box-header bg-blue" align="center">
    					<h4 class="box-title">Edit Registry of ICS-Issued</h4>
    				</div><br>
    				<div class="row">
    					<div class="col-md-12">
	    					<form action="" method="post" enctype="multipart/form-data">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-3">
    						            ...
    						            <input list="rescenter_options" class="form-control" id="rescenter" placeholder="Responsibility Center" name="rescenter" value="<?php echo $row['responsibilitycenter_id']; ?>" autocomplete="off">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-4">
		    						    ...
		    						    <textarea type="text" class="form-control" id="brand" placeholder="Brand/Model" name="brand" style="text-transform: uppercase;" autocomplete="off"><?php echo $row['brand']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-4">
		    						    <label for="serialno"> Serial Number</label>
		    						    <textarea type="text" class="form-control" id="serial_no" placeholder="Serial Number" name="serial_no" autocomplete="off"><?php echo $row['serialno']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-4">
	    						...
	    						<div class="form-group">
	    							<div class="col-md-6">
		    						    ...
		    						    <textarea type="text" class="form-control" id="remarks" placeholder="Remarks"name="remarks" autocomplete="off"><?php echo $row['remarks']; ?></textarea>
	    						    </div>
	    						</div>
	    						<div class="form-group">
	    							<div class="col-md-3">
	    						...
	    						<div class="col-md-2"><!-- Save Button Registry -->
	    							<div class="form-group">
	    								<button type="submit" class="btn btn-success" name="btn_ICS_update" onClick="">UPDATE</button>
	    							</div>
	    						</div><!-- End of Save Button Registry -->
	    						<div class="col-md-2"><!-- Cancel Button Registry -->
	    							<div class="form-group">
	    								<a href="active_semi_expendable.php" class="btn btn-danger">Cancel</a>
	    							</div>
